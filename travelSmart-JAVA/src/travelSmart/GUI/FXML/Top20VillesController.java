 ...
 * @author Ines
 */
public class Top20VillesController implements Initializable, InterfaceScreenController {
    ...
    public void showHome(ActionEvent e) throws Exception {
        stackEcrans.loadScreen("home", "HomeScreen.fxml");
